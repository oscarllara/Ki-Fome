        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button variant="ghost" size="sm" className="text-orange-600 font-black uppercase text-[10px] tracking-widest">Ver todos</Button>
            </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button variant="ghost" size="sm" className="text-orange-600 font-black uppercase text-[10px] tracking-widest">Gerenciar</Button>
            </div>
